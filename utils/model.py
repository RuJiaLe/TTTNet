...
class Model(nn.Module):
    ...
    def __init__(self, pretrained=True):
        ...
        self.decoder4 = Video_Decoder_Part(512,
                                           256,
                                           img_size=8,
                                           num_heads=16,
                                           mlp_ratio=4,
        ...
        self.decoder3 = Video_Decoder_Part(256,
                                           128,
                                           img_size=16,
                                           num_heads=8,
                                           mlp_ratio=4,
        ...
        self.decoder2 = Video_Decoder_Part(128,
                                           64,
                                           img_size=32,
                                           num_heads=4,
                                           mlp_ratio=8,
        ...
        self.decoder1 = Video_Decoder_Part(64,
                                           32,
                                           img_size=64,
                                           num_heads=2,
                                           mlp_ratio=8,
        ...
        # --------------------第0解码阶段--------------------
        self.CBR0 = CBR(32, 32)
        self.decoder0 = Video_Decoder_Part(32,
                                           32,
                                           img_size=128,
                                           num_heads=2,
                                           mlp_ratio=8,
    ...
    def forward(self,
                frames):  # (1, 2048, 8, 8)  [block1, block2, block3, block4]
        # --------------------编码阶段--------------------
        blocks_1 = []
        blocks_2 = []
        ...
        # --------------------refine_out--------------------
        final_output = []
        for i in range(len(refine_output[0])):  # 解码阶段
            stage = []
            for j in range(len(frames)):  # 帧数
                x = refine_output[j][i]
                stage.append(x)

            final_output.append(stage)

        return [output4, output3, output2, output1, output0], final_output
